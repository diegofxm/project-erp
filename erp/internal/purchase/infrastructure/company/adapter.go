// Package company implementa domain.CompanyPort de purchase leyendo del repositorio de
// empresas del ERP — mismo patrón que sales/infrastructure/company y electronic/infrastructure/company.
package company
