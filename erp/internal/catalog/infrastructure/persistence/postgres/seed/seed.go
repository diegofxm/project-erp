// Package seed carga los 13 catálogos DIAN/DANE desde CSVs embebidos.
package seed
...
// All carga los 13 catálogos. Es idempotente: ON CONFLICT DO UPDATE.
// Orden importa: departments debe existir antes que municipalities.
