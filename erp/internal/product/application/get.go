...
func (uc *GetUseCase) ByID(ctx context.Context, companyID, id uuid.UUID) (*domain.Product, error) {
	return uc.repo.GetByID(ctx, companyID, id)
}

func (uc *GetUseCase) List(ctx context.Context, companyID uuid.UUID) ([]domain.Product, error) {
