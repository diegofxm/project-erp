...
func (uc *GetUseCase) ByID(ctx context.Context, companyID, id uuid.UUID) (*domain.Supplier, error) {
	return uc.repo.GetByID(ctx, companyID, id)
}

func (uc *GetUseCase) List(ctx context.Context, companyID uuid.UUID) ([]domain.Supplier, error) {
