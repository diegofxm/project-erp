...
import (
	...
	"github.com/diegofxm/erp/internal/supplier/application"
...
func (h *Handler) handleCreate(w http.ResponseWriter, r *http.Request) {
	...
	s, err := h.create.Execute(r.Context(), companyID, req)
	if err != nil {
		if errors.Is(err, domain.ErrDuplicateSupplier) {
...
func (h *Handler) handleList(w http.ResponseWriter, r *http.Request) {
	...
	respond(w, http.StatusOK, map[string]any{"suppliers": list, "count": len(list)})
}
...
func (h *Handler) handleGetByID(w http.ResponseWriter, r *http.Request) {
	...
	s, err := h.get.ByID(r.Context(), companyID, id)
	if err != nil {
...
func (h *Handler) handleUpdate(w http.ResponseWriter, r *http.Request) {
	...
	s, err := h.update.Execute(r.Context(), companyID, id, req)
	if err != nil {
		if errors.Is(err, domain.ErrSupplierNotFound) {
			respondError(w, http.StatusNotFound, err.Error())
			return
