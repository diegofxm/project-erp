...
// Handler procesa un evento. El error de retorno ya NO se descarta -- Publish lo recolecta y
// lo devuelve a quien publicó, para que decida si es un problema real (registrarlo en
