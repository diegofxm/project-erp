...
func NewPaymentUseCase(paymentRepo domain.PaymentRepository, saleRepo domain.Repository) *PaymentUseCase {
	return &PaymentUseCase{paymentRepo: paymentRepo, saleRepo: saleRepo}
}
