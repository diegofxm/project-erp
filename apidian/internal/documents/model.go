...
// Status es el estado del ciclo de vida de un documento dentro de apidian — independiente
...
// pueda cambiar después de emitir (ver docs/apidian-architecture.md sección 9.21).
