...
// parseable. documents es el único paquete de api-dian que importa cofacture directamente
// (ver docs/api-dian-architecture.md sección 4.1) — por eso esta función vive aquí, no en
