...
export function DebitNotesPage() {
  ...
  useEffect(() => {
    setLoadingPage(true);
    listDocuments({ dian_document_type_code: DEBIT_NOTE_DIAN_DOCUMENT_TYPE, limit: PAGE_SIZE, offset })
      .then(setDocuments)
  ...
  return (
    <div className="p-4">
      <div className="mb-3 flex items-center justify-between">
        <h1 className="text-sm font-semibold text-(--text-primary)">Nota Débito</h1>
      </div>
      ...
      {documents === null ? (
        ...
        <p className="text-xs text-(--text-secondary)">
          Todavía no has emitido ninguna nota débito. Para crear una, abre una factura confirmada y usa el botón
          "Emitir Nota Débito".
        </p>
      ) : (
