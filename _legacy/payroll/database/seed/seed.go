...
// SMMLV carga los valores históricos del salario mínimo mensual legal vigente.
// Es idempotente: ON CONFLICT DO UPDATE no duplica filas.
...
// ARLRates carga las tasas de riesgo ARL por clase y año.
