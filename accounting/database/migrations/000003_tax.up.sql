...
--
-- Las tasas históricas de income_tax_rates se cargan vía seed (accounting/database/seed/income_tax_rates.csv),
-- no aquí — mismo patrón que uvt_values y withholding_concepts.
...
--
-- concept_code = account_code de la cuenta de retención (permite recalcular sin FK a
-- withholding_concepts — mismo patrón de aislamiento que ica_tariffs.municipality_code).
...
-- ── F490 ICA Municipal ────────────────────────────────────────────────────────────────────────
--
-- municipality_code y ciiu_code sin FK a public.municipalities/ciiu_codes: el módulo
-- accounting es autónomo, los códigos se pasan como valores de búsqueda, no como FKs.
